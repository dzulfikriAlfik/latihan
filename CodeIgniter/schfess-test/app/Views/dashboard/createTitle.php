   ...
   <div class="my-5 row">
      <div class="col-8">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
               <input type="text" class="form-control <?= ($validation->hasError('title')) ? 'is-invalid' : ''; ?>" id="title" placeholder="Masukan Judul Movie" name="title" value="<?= old('title'); ?>">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
               <select class="custom-select" id="inputGroupSelect01" name="id_genre">
                  ...
                  <option value="<?= $list['id_genre']; ?>"><?= $list['genre']; ?></option>
                  <?php endforeach; ?>
               </select>
