                     ...
                     <div class="p-5">
                        ...
                        <form action="<?=route_to('register');?>" method="post" class="user">
                           ...
                           <div class="form-group">
                              ...
                              <small id="emailHelp" class="form-text text-muted text-center"><?=lang('Auth.weNeverShare');?></small>
                           </div>
                           <div class="form-group">
                              <input type="text" class="form-control form-control-user <?php if (session('errors.username')): ?>is-invalid<?php endif;?>" placeholder="<?=lang('Auth.username');?>" value="<?=old('username');?>"
                                 name="username">
                           </div>
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <input type="password" name="pass_confirm" class="form-control form-control-user <?php if (session('errors.pass_confirm')): ?>is-invalid<?php endif;?>" placeholder="<?=lang('Auth.repeatPassword');?>"
                                    autocomplete="off">
                              </div>
                           </div>
