    ...
    <div class="row fullscreen d-flex align-items-center justify-content-between">
      <div class="banner-content col-lg-9 col-md-12">
        <h2 class="text-uppercase text-white">
          {{ config('sekolah.banner_1') }} <br>
          {{ config('sekolah.banner_2') }}
        </h2>
        <p class="pt-10 pb-10">
          {{ config('sekolah.paragraf_banner') }}
        </p>
        <a href="#" class="primary-btn text-uppercase">{{ config('sekolah.button_jelajah') }}</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="single-feature">
          <div class="title">
            <h4>{{ config('sekolah.banner_kolom1') }}</h4>
          </div>
          <div class="desc-wrap">
            <p>
              {{ config('sekolah.banner_kolom1_text') }}
            </p>
            <a href="#">{{ config('sekolah.button_jelajah') }}</a>
          </div>
        </div>
      </div>
      {{-- End Banner Kolom 1 --}}
      ...
      <div class="col-lg-4">
        <div class="single-feature">
          <div class="title">
            <h4>{{ config('sekolah.banner_kolom2') }}</h4>
          </div>
          <div class="desc-wrap">
            <p>
              {{ config('sekolah.banner_kolom2_text') }}
            </p>
            <a href="#">{{ config('sekolah.button_jelajah') }}</a>
          </div>
        </div>
      ...
      <div class="col-lg-4">
        <div class="single-feature">
          <div class="title">
            <h4>{{ config('sekolah.banner_kolom3') }}</h4>
          </div>
          <div class="desc-wrap">
            <p>
              {{ config('sekolah.banner_kolom3_text') }}
            </p>
            <a href="#">{{ config('sekolah.button_jelajah') }}</a>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 single-blog">
        ...
        <a href="{{ route('site.single.post', $post->slug) }}"
          class="details-btn d-flex justify-content-center align-items-center"><span class="details">Details</span><span
