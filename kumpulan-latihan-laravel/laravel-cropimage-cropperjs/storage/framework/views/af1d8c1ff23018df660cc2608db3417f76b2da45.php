...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('imageupload')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Programming\wamp64\www\latihan\kumpulan-latihan-laravel\laravel-cropimage-cropperjs\resources\views/welcome.blade.php ENDPATH**/ ?>