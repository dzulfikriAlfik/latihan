                        ...
                        <div class="p-6 text-gray-900 overflow-x-scroll">
                            <form @submit.prevent="submit" class="flex flex-col gap-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <TextInput id="owner_name" type="text" v-model="form.owner_name" :disabled="form.processing" />
                                    <InputError :message="form.errors.owner_name" />
                                </div>

                                <div class="form-group">
                                    <InputLabel for="city_id" value="City" />
                                    <SelectInput id="city_id" v-model="form.city_id" :options="cities" option-value="id" option-label="name" :default-option="{
                                        id: '',
                                        name: 'City Name'
                                ...
                                <div class="form-group">
                                    ...
                                    <TextareaInput id="address" v-model="form.address" class="resize-none" rows="3" :disabled="form.processing" />
