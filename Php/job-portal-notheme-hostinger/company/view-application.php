    ...
    <div class="row">
      ...
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          ...
          $sql = "SELECT * FROM apply_job_post INNER JOIN users ON apply_job_post.id_user=users.id_user WHERE apply_job_post.id_user='$_GET[id_user]' AND apply_job_post.id_jobpost='$_GET[id_job]' ";
