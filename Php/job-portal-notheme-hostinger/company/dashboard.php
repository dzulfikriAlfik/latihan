...
<html lang="en">
  ...
  <div class="container">
    ...
    <?php  
    unset($_SESSION['jobPostUpdateSuccess']); }
    ?>
    ...
    <?php  
    unset($_SESSION['jobPostDeleteSuccess']); }
    ?>
    ...
    <div class="row">
      ...
      <?php  
        ...
        if( $result->num_rows > 0 ) { ?>
          ...
          <div class="col-md-3">
            <a href="view-job-application.php" class="btn btn-success btn-block btn-lg">View Application <span class="badge"><?= $result->num_rows; ?></span></a>
          </div>
