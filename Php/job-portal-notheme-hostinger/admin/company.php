...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <?php if( isset($_SESSION['companyDeleteSuccess']) ) { ?>
      <div class="row">
      ...
      <?php  
      unset($_SESSION['companyDeleteSuccess']); }
      ?>
          ...
          <tbody>
            ...
            if( $result->num_rows > 0 ) {
              ...
              <tr>
                ...
                <td><?= $row['contactno']; ?></td>
                <td><?= $row['email']; ?></td>
                <td><a style="color:red" href="delete-company.php?id=<?= $row['id_company']; ?>">Delete</a></td>
              </tr>
