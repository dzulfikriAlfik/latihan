          ...
          <h2 class="text-center">Login</h2>
            <form method="post" action="checklogin.php">
              ...
              if(isset($_SESSION['loginError'])) {
                ?>
                <div>
                  <p id="successMessage" class="text-center">Invalid email/password ! Please try again !</p>
                </div>
              <?php 
              ...
              if(isset($_SESSION['userActivated'])) {
                ?>
                <div>
                  <p id="successMessage" class="text-center"><?= $_SESSION['userActivated']; ?></p>
                </div>
              <?php 
              ...
              if(isset($_SESSION['loginActiveError'])) {
                ?>
                <div>
                  <p id="successMessage" class="text-center">Your Account Is Not Active. Check Your Email</p>
                </div>
              <?php 
