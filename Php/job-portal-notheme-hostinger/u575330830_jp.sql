...
CREATE TABLE `company` (
  ...
  `headofficecity` varchar(255) DEFAULT NULL,
...
INSERT INTO `company` (`id_company`, `companyname`, `headofficecity`, `provinsi`, `kota`, `kecamatan`, `contactno`, `website`, `companytype`, `email`, `password`, `createdAt`, `active`) VALUES
(1, 'PT Inatel Nusantara', 'Cianjur', '', '', '', '802121884879', 'inatelnusantara.com', 'Project FO', 'inatel@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', '2019-03-16 10:07:04', 1),
(2, 'Bank Jabar Banten', 'Bandung', '', '', '', '081276555432', 'bjb.co.id', 'Banker', 'bjb@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', '2019-03-16 10:07:04', 1),
(3, 'PT IT Group Adhiyasa', 'Jakarta', '', '', '', '087123655777', 'adhiyasa.com', 'IT Group', 'adhiyasa@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', '2019-03-16 10:07:04', 1),
(4, 'PT Kalbe Farma', 'Surabaya', '', '', '', '087123333435', 'kalbefarma.co.id', 'Farmasi', 'kalbe@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', '2019-03-16 10:07:04', 1),
(5, 'Ramayana Travel Group Bali', 'Bali', '', '', '', '085332578940', 'ramatravel.com', 'Travel and Acomodation', 'ramatravel@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', '2019-03-16 10:07:04', 1),
(6, 'PT Mitrabara Adiperdana Tbk (Jakarta)', 'Jakarta', '', '', '', '082167856439', 'mitrabara@gmail.com', 'Manufaktur', 'mitrabara@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', '2019-03-16 10:07:04', 1);
...
(2, 2, 'Account Officer 1', 'Melakukan pemasaran, melakukan analisa kelayakan pemberian kredit, dan pemantauan terhadap kelancaran pembayaran debitur', '2000000', '3000000', '3', 'S1 Accounting', '2019-03-12 14:43:28'),
(3, 2, 'Marketing', 'Melakukan pemasaran dengan mencari nasabah', '3000000', '3500000', '2', 'S1 Marketing', '2019-03-12 14:44:56'),
(4, 2, 'Analis Kredit', 'Menganalisis penerima pinjaman, apakah bankable atau tidak', '1500000', '2500000', '1', 'S1 Analis', '2019-03-12 14:45:43'),
(5, 2, 'Sales officer', 'Executive: Marketing', '2500000', '3000000', '3', 'S1 Marketing', '2019-03-12 14:46:26'),
(6, 2, 'Segmen Operational', 'macam-macam posisi di bank dan tugasnya yang ada pada segmen ini yaitu harus mendukung sisi bisnis bank, dan menjalankan proses transaksi nasabah supaya berjalan lancar dan sesuai aturan/sistem yang ada', '3000000', '4000000', '4', 'Magister Management', '2019-03-12 14:47:16'),
(7, 1, 'Graphic Designer', 'Membuat As Plan dan As Build Drawing', '3500000', '5000000', '1', '-', '2019-03-12 14:49:49'),
(8, 1, 'Lean Manager', 'Planning improvement projects related to the improvement of systems and procedures to improve the companyâ€™s performance. Preparing a full...', '5000000', '7500000', '4', 'S1 Management', '2019-03-12 14:50:20'),
(9, 1, 'Site Manager', 'Planning improvement projects related to the improvement of systems and procedures to improve the companyâ€™s performance. Preparing a full...', '7500000', '10000000', '5', 'Magister Management', '2019-03-12 14:50:56'),
(10, 1, 'Estimator & Field Supervisor', 'Mangawal Pekerjaan dan mengatasi permasalahan di Lapangan ', '3000000', '4500000', '3', '-', '2019-03-12 14:51:43'),
(11, 1, 'Marketing Sales Staff', 'Responsibilities: Responsible for all client communications, conflict resolution, and compliance on client deliverables and revenue. Reviews all major...', '5000000', '7000000', '4', 'Magister Marketing', '2019-03-12 14:52:25'),
(12, 3, 'Web Programmer', 'TANGGUNG JAWAB: Penulisan coding yang bersih dan dirancang dengan baik. Troubleshoot, uji dan modifikasi perangkat lunak produk inti dan basis data untuk memastikan optimalisasi dan fungsionalitas yang kuat. Kuat dalam OOP (Objek Oriented Programming), Kerangka kerja. CP-DOM. Mengetahui Life Cycle...', '4000000', '5000000', '2', 'S1 Komputer', '2019-03-12 14:59:08'),
(13, 3, 'BI Consultant (Tableau)', 'Successful candidates will be responsible on developing a best of class BI solutions using the latest technologies in enterprise multi national...\r\nSkills - Business Intelligence, Report, Oracle, SQL, Tableau', '4500000', '6000000', '5', 'Magister komputer', '2019-03-12 15:00:04'),
(14, 3, 'PHP Developer', 'Experienced using various web- based application development technologies such as PHP, React, API, CSS, Phyton (more preferable)....', '5000000', '6000000', '2', 'S1 Komputer', '2019-03-12 15:00:32'),
(15, 3, 'Senior Java Developer', 'Ringkasan Pengalaman &Kualifikasi Kandidat harus memiliki pendidikan minimal Diploma di Teknik (Komputer/Telekomunikasi), Ilmu Komputer/Teknologi...', '6000000', '8000000', '4', 'Magister Komputer', '2019-03-12 15:01:26'),
(16, 3, 'Mobile Developer (Android / iOS)', 'Job Descriptions: Working with other teams that appointed to build the application. Independently perform unit test on each function and module being...', '4000000', '5500000', '1', 'S1 Komputer', '2019-03-12 15:02:08'),
(17, 3, 'IT Audit Manager', 'Lead a team of IT auditors to perform IT audit, IT general control, and IT risk management activities. Assist in formulating the...', '6000000', '7500000', '5', 'S1 Consultant IT', '2019-03-12 15:02:56'),
(18, 3, 'IOS Programmer', 'Kandidat harus memiliki setidaknya SMA, Diploma, Gelar Sarjana di Teknik (Komputer/Telekomunikasi) atau setara. Mengerti IOS - SWIFT/Objective C Programming languange. Mengerti cara menggunakan POD module management untuk XCode. Mengerti bahasa inggris meskipun sedikit tapi mengerti. Bisa mencari...', '3000000', '4000000', '3', 'SMA', '2019-03-12 15:03:30'),
(19, 4, 'Logistic Supervisor', 're you the one that we are looking for? Qualification: Fresh graduates Engineering (Industrial) or Apothecary are welcome to apply. Minimum GPA 3,00...', '3000000', '4000000', '1', 'S1 Farmasi', '2019-03-12 15:05:12'),
(21, 4, 'Apoteker Penanggung Jawab (APJ)', 'Tanggung Jawab Pekerjaan : -Melaksanakan kegiatan pelayanan kefarmasian yang bermutu & efisien (konsultasi, memberikan informasi & edukasi)', '3200000', '4300000', '1', 'Jujur dan Tanggung jawab', '2019-03-12 15:06:33'),
(22, 4, 'PJT (Penanggung Jawab Teknis)', 'Pendidikan Apoteker. Pengalaman minimal 1 tahun (diutamakan dibidang ALKES dan PKRT). Memiliki kemampuan dibidang Quality Control, Quality Assurance,...', '3000000', '3400000', '1', 'Sertifikat Apoteker', '2019-03-12 15:07:13'),
(23, 4, 'Penanggung Jawab Alat Kesehatan (IPAK)', 'Pendidikan Apoteker dengan pengetahuan mengenai UU dan peraturan tentang Distribusi AlKesDiutamakan memiliki STRA (Surat Tanda...', '1500000', '2500000', '2', 'Setifikat Apoteker', '2019-03-12 15:07:58'),
(24, 5, 'Quotation Executive', 'Candidate must possess at least SMU in Hospitality/Tourism/Hotel Management or equivalent. Required language(s): English, Bahasa Indonesia. At least...', '3000000', '5000000', '2', 'SMA', '2019-03-12 15:10:04'),
(25, 5, 'Kitchen Crew', 'Kandidat harus memiliki setidaknya SMA di bidang apapun. Setidaknya memiliki 3 tahun pengalaman dalam bidang yang sesuai untuk posisi ini. Lebih...', '2500000', '4000000', '3', '-', '2019-03-12 15:10:43'),
(26, 5, 'Kasir merangkap Waiter atau Waitress', 'Pendidikan minimal SMU atau SMK. Usia maksimal 27 tahun. Berpenampilan rapi. Mempunyai pengalaman bekerja di Kafe minimal 1 tahun sebagai kasir...', '3000000', '4300000', '1', '-', '2019-03-12 15:11:11'),
(27, 5, 'Senior Barista', 'Candidate must possess at least SMU in any field with age maximum of 30 years old. At least 3 Year(s) of working experience in the related field is...', '4500000', '6000000', '3', 'SMU', '2019-03-12 15:11:38'),
(28, 6, 'Mining Production Superintendent', '1. Berusia max 40 tahun. 2. Pendidikan min S1. Teknik Pertambangan/Geologi/Mesin. 3. Berpengalaman min. 5 tahun di perusahaan tambang batubara...', '5000000', '8000000', '5', '123', '2019-03-12 15:34:37'),
(29, 6, 'Site Coordinator', 'Persyaratan : Minimal lulusan STM/D3 atau sederajat. Berpengalaman dalam bisnis HYDRAULICS HOSE minimal 5 tahun. Min SLTA/sederajat, umur max 35...', '7000000', '8000000', '5', 'STM', '2019-03-12 15:35:13');
...
(1, 'Dzulfikri', 'Alkautsari', 'alfik@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Cikjiing Blok Rebo', 'Majalengka', 'Jawa Barat', '082121884879', 'S1', 'Komputer', '2018-12-24', '1995-11-29', '23', 'Informatika', '5c8d4184a9085.pdf', NULL, 1),
(2, 'Ica', 'Cahyani', 'ica@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Kiara Condong', 'Bandung', 'Jawa Barat', '089507436748', 'S1', 'English Literature', '2018-10-22', '1996-07-03', '23', 'English Literature', '5c8a7820eb7eb.docx', NULL, 1),
(3, 'Ayub ', 'Syahputra', 'ayub@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Sindangkasih', 'Majalengka', 'Jawa Barat', '087999444543', 'SMA', 'IPA', '2014-09-22', '1995-06-17', '23', 'IPA', '', NULL, 1),
(4, 'Iqbal', 'Firdaus', 'ikbal@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Sukaraja Wetan', 'Majalengka', 'Jawa Barat', '089876567666', 'S1', 'Design', '2019-03-13', '1989-06-07', '31', 'Design', '', NULL, 1),
(5, 'iman ', 'Hermawan', 'iman@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Cikijing', 'Majalengka', 'Jawa Barat', '087565448980', 'S1', 'Informatika', '2019-03-20', '1994-05-16', '24', 'Infromatika', '', NULL, 1),
(6, 'Ali', 'Imron', 'ali@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Cicurug', 'Majalengka', 'Jawa Barat', '089509832578', 'SMA', 'IPS', '2014-09-22', '1993-08-04', '25', 'IPS', '', NULL, 1),
(7, 'Rini', 'Zulfa', 'rini@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Maja', 'Majalengka', 'Jawa Barat', '082432126780', 'S1', 'Accountant', '2019-09-28', '1996-10-15', '22', 'Accountant', '', NULL, 1),
(35, 'Dzulfikri', 'Alkautsari', 'alfikperfect@gmail.com', 'MDdiNDMyZDI1MTcwYjQ2OWI1NzA5NWNhMjY5YmMyMDI=', 'Blok Rebo RT/002 RW/005 Desa/Kecamatan Cikijing', 'Majalengka', 'Jawa Barat', '082121884879', 'S1', 'Informatika', '2018-12-24', '1995-11-29', '23', 'Informatika', '5c8dd92cba13a.docx', 'bdc548df05f6a0e7d9c9364305482af9', 1),
(37, 'Alfik', 'alfik', 'dzulfikrialfik@gmail.com', 'YmJmNWFiMTliODM1ZjEzZGIwOTg1ODFjODRjN2FjYmY=', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '33bf222ee027749b73694be56b478902', 1),
(39, 'emed', 'muhammad', 'fikriallfik@gmail.com', 'YjdlNDhmMTk4NjFhNDNjNGM2MDdhOGFlZTBiY2M3Mjg=', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'f94a86a496a8b99d6849e770cd979a76', 0);
...
--
ALTER TABLE `apply_job_post`
  MODIFY `id_apply` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `job_post`
  MODIFY `id_jobpost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
