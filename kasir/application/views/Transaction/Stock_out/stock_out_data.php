                        ...
                        foreach ($row as $data => $stock) : ?>
                           <tr>
                              ...
                              <td width="160px" class="text-center">
                                 ...
                                 <a href="<?= base_url('stock/out/delete/' . $stock['stock_id'] . '/' . $stock['item_id']); ?>" onclick="return confirm('Yakin Hapus Data?')" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i> Hapus</a>
                              </td>
                           </tr>
                        <?php endforeach; ?>
                     </tbody>
