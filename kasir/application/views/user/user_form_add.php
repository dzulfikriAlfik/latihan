                  ...
                  <div class="row d-flex justify-content-center">
                     <div class="col-md-5 mx-3">
                        <div class="form-group">
                           ...
                           <?= form_error('fullname', '<div class="small text-danger">', '</div>'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <?= form_error('passconf', '<div class="small text-danger">', '</div>'); ?>
                        </div>
                     </div>
                     <div class="col-md-5 mx-3">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <?= form_error('level', '<div class="small text-danger">', '</div>'); ?>
                        </div>
                        <div class="form-group">
