...
import { SafeAreaView, View, Text, TextInput, Pressable, Image, Dimensions, TouchableHighlight, ToastAndroid, ActivityIndicator } from "react-native"
        ...
        <Fragment>
            <SafeAreaView>
                <View style={ Tailwind`w-full max-h-full flex flex-row` }>
                    <View style={ Tailwind`w-1/2 min-h-full bg-primary--red ${ handleResponsive(["hidden"], "flex") } flex-col items-center justify-center` }>
                        <Image
                    ...
                    <View style={ Tailwind`${ handleResponsive(["w-full", "w-1/2"]) } min-h-full bg-white flex flex-col items-center justify-center py-6 ${ handleResponsive(["px-6", "px-16"]) }` }>
                        <Text style={ Tailwind`font-rubik-medium text-3xl text-primary--red` }>
                            Login Account
                        </Text>
                        <Text style={ Tailwind`font-rubik-regular text-sm text-accent--black opacity-50 text-center mt-2 tracking-wide leading-relaxed` }>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere iure excepturi qui molestias, voluptas distinctio?
                        </Text>
                        <TextInput
                        ...
                        />
                        <View style={ Tailwind`font-rubik-regular w-full px-5 py-4 rounded-md bg-transparent bg-gray-100 mt-3 flex flex-row items-center justify-between border-l-4 border-primary--red` }>
                            <TextInput
                        ...
                        <View style={ Tailwind`w-full flex flex-row items-center justify-between mt-3` }>
                            <TouchableHighlight underlayColor={ "#10101010" } onPress={ () => navigation.push("ForgotPin") }>
                                <Text style={ Tailwind`font-rubik-regular text-primary--red text-xs` }>
                                    Forgot Password?
                                </Text>
                            </TouchableHighlight>
                        </View>
                        <TouchableHighlight underlayColor={ "#10101010" } style={ Tailwind`w-full mt-10 rounded-lg` } onPress={ () => submitForm() }>
                            {
