...
const DetailReportDaily = ({ navigation, user, route }) => {
    ...
    useEffect(() => {
        async function initData() {
            setIsLoading(true)
            const response = await ReportFetching().detailDailyReport(route.params.data.date)
...
export default connect(mapStateToProps, null)(DetailReportDaily)