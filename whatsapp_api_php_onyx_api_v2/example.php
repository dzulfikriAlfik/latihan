...
$wp = new WhatsappAPI("3826", "f3c7e4231f2d47ef8d4f4ca46943ad5187a7a7aa"); // create an object of the WhatsappAPI class with your user id and api key

// $number = '+6282121884879'; // NOTE: Phone Number should be with country code
$number = '+62882002350684'; // NOTE: Phone Number should be with country code
